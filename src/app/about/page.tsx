      ...
      <div className="relative overflow-hidden border-b bg-muted/30">
        ...
        <div className="container mx-auto max-w-5xl px-4 py-20 md:py-28 text-center relative z-10 space-y-4">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/80">DevOps Hub</span>
          </h1>
        ...
        <div className="space-y-10">
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              DevOps Hub was built with a single goal in mind: simplifying complexity. 
